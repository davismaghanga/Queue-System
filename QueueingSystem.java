...
//set everything to zero
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            inFile = new Scanner(new FileReader("mml.in"));
        ...
        try {
            ...
            outFile.println("A single server queueing system\n\n");
       ...
       // System.out.println("Done writing");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("mm1.out"))){
        String line = null;
        while ((line = br.readLine())!=null){
             System.out.println(line);
        }
        } catch (IOException ex) {
            Logger.getLogger(QueueingSystem.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
